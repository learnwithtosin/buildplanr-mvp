...
// Registered before "/:id" so the export/name-suggestions paths never fall
// through to the status handler (":id" only matches a single segment, but
// explicit ordering keeps intent obvious).
